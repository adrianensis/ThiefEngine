...
CircleCollider.prototype.testVertexVertex = function (vertices, otherCollider, contactManager) {
  return Collider.STATUS_NONE;
};

//----------------------------------------------------------------------

CircleCollider.prototype.testVertexEdge = function (vertices, otherCollider, contactManager) {
