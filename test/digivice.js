var test = function () {
  ...
  // Thief.spriteBuilder.begin("test/res/digi/map.png", new Vector2(0,0), 1, true).end();
  //
  // var w = 1/8;
  // var h = 1/6;
  // Thief.spriteBuilder.begin("test/res/digi/digi1.png", new Vector2(0,0.1), 0.5, true).
